...
mkdir -p $BRESEQ_OUTPATH/cutadapt-fastx
...
breseq -r ${REFERENCE_CHR} -r ${REFERENCE_PAB1} -r ${REFERENCE_PAB2} -r ${REFERENCE_PAB3} -o $BRESEQ_OUTPATH/cutadapt-fastx/${name} ${r1}
