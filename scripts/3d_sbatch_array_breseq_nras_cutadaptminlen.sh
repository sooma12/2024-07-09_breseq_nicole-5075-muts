...
#SBATCH --job-name=breseq_array_nra_cutadapt
...
cutadapt_sheet=/work/geisingerlab/Mark/breseq/2024-07-09_breseq_nicole-5075-muts/input/fastq/trimmed_cutadapt_34minlen_egadapter/sample_sheet_cutadapt_minlen.txt
...
breseq -r ${REFERENCE_CHR} -r ${REFERENCE_PAB1} -r ${REFERENCE_PAB2} -r ${REFERENCE_PAB3} -o ${BRESEQ_OUTPATH}/${name}_cutadapt ${r1}
