...
#SBATCH --job-name=breseq_array_cutadapt
#SBATCH --time=08:00:00
#SBATCH --array=1-94%20
#SBATCH --cpus-per-task=1
#SBATCH --mem=200G
#SBATCH --output=/work/geisingerlab/Mark/breseq/2024-07-09_breseq_nicole-5075-muts/logs/breseq-cutadapt/%x_%A_%a.out
#SBATCH --error=/work/geisingerlab/Mark/breseq/2024-07-09_breseq_nicole-5075-muts/logs/breseq-cutadapt/%x_%A_%a.err
...
cutadapt_sheet=/work/geisingerlab/Mark/breseq/2024-07-09_breseq_nicole-5075-muts/sample_sheet_cutadapt.txt
